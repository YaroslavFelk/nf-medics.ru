...
<div class="catalog_item_block">
    ...
    <div class="catalog_header_block">
        ...
        <div class="catalog_instock_art" style="display: none">
            <?php
...
?>
        ...
        <a class="btn_white" data-toggle="pkModal" data-target="#callbackModal"  data-ajax="/ajax/taskInformation.php">
            <? $APPLICATION->IncludeComponent(
                "bitrix:main.include",
                "",
                array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => '/include/catalog/catalog_item__button.php',
                )
            ); ?>
        </a>
    </div>
